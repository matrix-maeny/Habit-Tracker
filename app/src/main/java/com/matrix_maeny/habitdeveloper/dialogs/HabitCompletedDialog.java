...
public class HabitCompletedDialog extends AppCompatDialogFragment {

    private HabitCompletedDialogBinding binding;
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        @SuppressLint("InflateParams") View root = requireActivity().getLayoutInflater().inflate(R.layout.habit_completed_dialog, null);
        binding = HabitCompletedDialogBinding.bind(root);
